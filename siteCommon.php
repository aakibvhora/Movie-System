                ...
                <div>
                    ...
                    <div id="navbar navbar-left" class="navbar-collapse collapse row">
                        ...
                        <ul class="nav navbar-nav">
                            <li><a href="mslogin.php"><span class="fa fa-home"
                                 aria-hidden="true"></span> Home</a></li>
                            <li><a href="msbrowse.php"><span class="fa fa-folder-o"
                                 aria-hidden="true"></span> Browse Movies</a></li>
                             <li><a href="mssearch.php"><i class="fa fa-search"></i> Search Movies</a></li>
                              </ul>
                        </div>
ABC;
                            ...
                            <form class="navbar-form navbar-right" role="form" method="post" action="mslogin.php">
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-xs-12 col-sm-3">
                                            <input type="text" name="username" class="form-control" id="username" placeholder="User Name" autofocus>
                                        </div>
...
STR;
    ...
    else
    {
        $str = <<<STR
        <div class="navbar-right  col-xs-12 col-sm-7 col-lg-6">
        <ul class="nav navbar-nav navbar-right col-xs-5">
        <li class="dropdown pull-right">
        <a href="#" style="margin-right:30px;" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="false">My Account <b class="caret"></b></a>
        <ul style="margin-right:30px; float:right;" class="dropdown-menu">
          <li><a href="msmodify.php">Modify Account</a></li>
          <li><a href="mswatchlist.php">Watchlist</a></li>
          
          <li class="divider"></li>
          <li><a href="mslogout.php">Logout</a></li>
        </ul>
      </li>
      </ul>
      </div>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="design">
					 ...
					 Developed By: <a target="_blank" href="https://www.linkedin.com/in/aakib-vhora-a505a1a7/">Aakib Vhora</a> |  <a target="_blank" href="https://www.linkedin.com/in/sreenivaspotukuchi">Sreenivas Potukuchi</a> |  <a target="_blank" href="#">Sanjay Tanneeru</a>
